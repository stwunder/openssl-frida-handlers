/*
 * Auto-generated by Frida. Please modify to match the signature of IDEA_ecb_encrypt.
...
{
  /**
   * Called synchronously when about to call IDEA_ecb_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('IDEA_ecb_encrypt() intercepted onEnter.');  
    ...
    this.key = new Uint8Array(args[2].readByteArray(216));
  ...
  /**
   * Called synchronously when about to return from IDEA_ecb_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('IDEA_ecb_encrypt() intercepted onLeave.');
