/*
 * Auto-generated by Frida. Please modify to match the signature of SEED_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call SEED_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('SEED_cbc_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from SEED_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('SEED_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("SEED-CBC with constant IV called.");
