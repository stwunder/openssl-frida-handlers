/*
 * Auto-generated by Frida. Please modify to match the signature of BF_ecb_encrypt.
...
{
  /**
   * Called synchronously when about to call BF_ecb_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('BF_ecb_encrypt() intercepted onEnter.');  
    ...
    this.key = new Uint8Array(args[2].readByteArray(4168)); // 4168 = 18 * sizeof(int) + 1024 * sizeof(int)
  ...
  /**
   * Called synchronously when about to return from BF_ecb_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('BF_ecb_encrypt() intercepted onLeave.');
