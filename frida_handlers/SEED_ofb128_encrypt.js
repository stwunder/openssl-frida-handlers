/*
 * Auto-generated by Frida. Please modify to match the signature of SEED_ofb128_encrypt.
...
{
  /**
   * Called synchronously when about to call SEED_ofb128_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('SEED_ofb128_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from SEED_ofb128_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('SEED_ofb128_encrypt() intercepted onLeave.');
