...

{
  ...
  onEnter(log, args, state) {
    console.log('AES_ecb_encrypt() intercepted onEnter.');  
    console.warn("--- VIOLATION of Rule 1: Do not use ECB mode for encryption. ---");

    this.key = new Uint8Array(args[2].readByteArray(240)); // 240 = 60 * sizeof(int)
  ...
  onLeave(log, retval, state) {
    // console.log('AES_ecb_encrypt() intercepted onLeave.');
