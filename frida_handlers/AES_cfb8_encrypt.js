/*
 * Auto-generated by Frida. Please modify to match the signature of AES_cfb8_encrypt.
...
{
  /**
   * Called synchronously when about to call AES_cfb8_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('AES_cfb8_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from AES_cfb8_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('AES_cfb8_encrypt() intercepted onLeave.');
