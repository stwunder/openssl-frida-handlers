/*
 * Auto-generated by Frida. Please modify to match the signature of RC2_ecb_encrypt.
...
{
  /**
   * Called synchronously when about to call RC2_ecb_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('RC2_ecb_encrypt() intercepted onEnter.');  
    ...
    this.key = new Uint8Array(args[2].readByteArray(256));
  ...
  /**
   * Called synchronously when about to return from RC2_ecb_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('RC2_ecb_encrypt() intercepted onLeave.');
