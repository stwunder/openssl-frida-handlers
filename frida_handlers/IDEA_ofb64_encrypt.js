/*
 * Auto-generated by Frida. Please modify to match the signature of IDEA_ofb64_encrypt.
...
{
  /**
   * Called synchronously when about to call IDEA_ofb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('IDEA_ofb64_encrypt() intercepted onEnter.');  
  ...
  /**
   * Called synchronously when about to return from IDEA_ofb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('IDEA_ofb64_encrypt() intercepted onLeave.');
