/*
 * Auto-generated by Frida. Please modify to match the signature of Camellia_ctr128_encrypt.
...
{
  /**
   * Called synchronously when about to call Camellia_ctr128_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('Camellia_ctr128_encrypt() intercepted onEnter.');  
  ...
  /**
   * Called synchronously when about to return from Camellia_ctr128_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('Camellia_ctr128_encrypt() intercepted onLeave.');
