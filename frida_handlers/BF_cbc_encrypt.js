/*
 * Auto-generated by Frida. Please modify to match the signature of BF_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call BF_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('BF_cbc_encrypt() intercepted onEnter.');

    this.key = new Uint8Array(args[3].readByteArray(4168)); // 4168 = 18 * sizeof(int) + 1024 * sizeof(int)
  ...
  /**
   * Called synchronously when about to return from BF_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('BF_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("BF-CBC with constant IV called.");
