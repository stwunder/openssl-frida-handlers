/*
 * Auto-generated by Frida. Please modify to match the signature of Camellia_ofb128_encrypt.
...
{
  /**
   * Called synchronously when about to call Camellia_ofb128_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('Camellia_ofb128_encrypt() intercepted onEnter.');  
  ...
  /**
   * Called synchronously when about to return from Camellia_ofb128_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('Camellia_ofb128_encrypt() intercepted onLeave.');
