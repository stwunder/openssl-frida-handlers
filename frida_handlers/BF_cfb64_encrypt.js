/*
 * Auto-generated by Frida. Please modify to match the signature of BF_cfb64_encrypt.
...
{
  /**
   * Called synchronously when about to call BF_cfb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('BF_cfb64_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from BF_cfb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('BF_cfb64_encrypt() intercepted onLeave.');
