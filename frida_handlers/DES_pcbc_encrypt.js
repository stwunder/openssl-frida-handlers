/*
 * Auto-generated by Frida. Please modify to match the signature of DES_pcbc_encrypt.
...
{
  /**
   * Called synchronously when about to call DES_pcbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('DES_pcbc_encrypt() intercepted onEnter.');
    console.warn("--- VIOLATION of Rule 7: Use of a Broken or Risky Cryptographic Algorithm. ---");

    this.key = new Uint8Array(args[3].readByteArray(128));
  ...
  /**
   * Called synchronously when about to return from DES_pcbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('DES_pcbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("DES-PCBC with constant IV called.");
