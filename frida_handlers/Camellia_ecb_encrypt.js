/*
 * Auto-generated by Frida. Please modify to match the signature of Camellia_ecb_encrypt.
...
{
  /**
   * Called synchronously when about to call Camellia_ecb_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('Camellia_ecb_encrypt() intercepted onEnter.');  
    console.warn("--- VIOLATION of Rule 1: Do not use ECB mode for encryption. ---");

    this.key = new Uint8Array(args[2].readByteArray(280)); // 128 = 8 + 68 * sizeof(int)
  ...
  /**
   * Called synchronously when about to return from Camellia_ecb_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('Camellia_ecb_encrypt() intercepted onLeave.');
