/*
 * Auto-generated by Frida. Please modify to match the signature of RC5_32_ofb64_encrypt.
...
{
  /**
   * Called synchronously when about to call RC5_32_ofb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('RC5_32_ofb64_encrypt() intercepted onEnter.');  
  ...
  /**
   * Called synchronously when about to return from RC5_32_ofb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('RC5_32_ofb64_encrypt() intercepted onLeave.');
