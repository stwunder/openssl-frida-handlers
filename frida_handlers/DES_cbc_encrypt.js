/*
 * Auto-generated by Frida. Please modify to match the signature of DES_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call DES_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('DES_cbc_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from DES_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('DES_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("DES-CBC with constant IV called.");
