...

{
  ...
  onEnter(log, args, state) {
    console.log('DES_ecb3_encrypt() intercepted onEnter.');  
    ...
    this.key1 = new Uint8Array(args[2].readByteArray(128));
    this.key2 = new Uint8Array(args[3].readByteArray(128));
    this.key3 = new Uint8Array(args[4].readByteArray(128));
  ...
  onLeave(log, retval, state) {
    // console.log('DES_ecb3_encrypt() intercepted onLeave.');  
