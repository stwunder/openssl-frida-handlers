/*
 * Auto-generated by Frida. Please modify to match the signature of Camellia_cfb8_encrypt.
...
{
  /**
   * Called synchronously when about to call Camellia_cfb8_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('Camellia_cfb8_encrypt() intercepted onEnter.');  
  ...
  /**
   * Called synchronously when about to return from Camellia_cfb8_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('Camellia_cfb8_encrypt() intercepted onLeave.');
