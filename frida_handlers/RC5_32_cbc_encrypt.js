/*
 * Auto-generated by Frida. Please modify to match the signature of RC5_32_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call RC5_32_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('RC5_32_cbc_encrypt() intercepted onEnter.');
    console.warn("--- VIOLATION of Rule 7: Use of a Broken or Risky Cryptographic Algorithm. ---");

    this.key = new Uint8Array(args[3].readByteArray(140));
    this.iv = new Uint8Array(args[4].readByteArray(8));
  ...
  /**
   * Called synchronously when about to return from RC5_32_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('RC5_32_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("RC5-CBC with constant IV called.");
