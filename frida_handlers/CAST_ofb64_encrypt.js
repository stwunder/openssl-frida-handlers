/*
 * Auto-generated by Frida. Please modify to match the signature of CAST_ofb64_encrypt.
...
{
  /**
   * Called synchronously when about to call CAST_ofb64_encrypt.
   *
  ...
  /**
   * Called synchronously when about to return from CAST_ofb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('CAST_ofb64_encrypt() intercepted onLeave.');
