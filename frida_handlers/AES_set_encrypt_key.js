...

{
  ...
  onEnter(log, args, state) {
    // console.log('AES_set_encrypt_key() intercepted onEnter.');

    this.keyLenght = args[1].toInt32() // 8;
    this.key = new Uint8Array(args[0].readByteArray(this.keyLenght));

    // console.log('keyLenght: ' + this.keyLenght);
  ...
  onLeave(log, retval, state) {
    // console.log('AES_set_encrypt_key() intercepted onLeave.');
