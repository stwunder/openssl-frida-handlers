/*
 * Auto-generated by Frida. Please modify to match the signature of CAST_cfb64_encrypt.
...
{
  /**
   * Called synchronously when about to call CAST_cfb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('CAST_cfb64_encrypt() intercepted onEnter.');  
  ...
  /**
   * Called synchronously when about to return from CAST_cfb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('CAST_cfb64_encrypt() intercepted onLeave.');
