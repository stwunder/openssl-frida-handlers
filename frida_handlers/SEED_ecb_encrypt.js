/*
 * Auto-generated by Frida. Please modify to match the signature of SEED_ecb_encrypt.
...
{
  /**
   * Called synchronously when about to call SEED_ecb_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('SEED_ecb_encrypt() intercepted onEnter.');  
    console.warn("--- VIOLATION of Rule 1: Do not use ECB mode for encryption. ---");
    
    this.key = new Uint8Array(args[2].readByteArray(128));
  ...
  /**
   * Called synchronously when about to return from SEED_ecb_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('SEED_ecb_encrypt() intercepted onLeave.');
