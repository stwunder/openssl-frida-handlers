/*
 * Auto-generated by Frida. Please modify to match the signature of BF_ofb64_encrypt.
...
{
  /**
   * Called synchronously when about to call BF_ofb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('BF_ofb64_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from BF_ofb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('BF_ofb64_encrypt() intercepted onLeave.');
