/*
 * Auto-generated by Frida. Please modify to match the signature of IDEA_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call IDEA_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('IDEA_cbc_encrypt() intercepted onEnter.');
    console.warn("--- VIOLATION of Rule 7: Use of a Broken or Risky Cryptographic Algorithm. ---");

    this.key = new Uint8Array(args[3].readByteArray(216));
  ...
  /**
   * Called synchronously when about to return from IDEA_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('IDEA_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("IDEA-CBC with constant IV called.");
