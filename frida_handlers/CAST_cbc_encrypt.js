/*
 * Auto-generated by Frida. Please modify to match the signature of CAST_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call CAST_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('CAST_cbc_encrypt() intercepted onEnter.');

    this.key = new Uint8Array(args[3].readByteArray(128)); // 128 = 32 * sizeof(int)
  ...
  /**
   * Called synchronously when about to return from CAST_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('CAST_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("CAST-CBC with constant IV called.");
