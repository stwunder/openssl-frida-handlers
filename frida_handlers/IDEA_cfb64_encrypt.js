/*
 * Auto-generated by Frida. Please modify to match the signature of IDEA_cfb64_encrypt.
...
{
  /**
   * Called synchronously when about to call IDEA_cfb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('IDEA_cfb64_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from IDEA_cfb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('IDEA_cfb64_encrypt() intercepted onLeave.');
