/*
 * Auto-generated by Frida. Please modify to match the signature of AES_cfb1_encrypt.
...
{
  /**
   * Called synchronously when about to call AES_cfb1_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('AES_cfb1_encrypt() intercepted onEnter.');

    this.key = new Uint8Array(args[3].readByteArray(240)); // 240 = 60 * sizeof(int)
  ...
  /**
   * Called synchronously when about to return from AES_cfb1_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('AES_cfb1_encrypt() intercepted onLeave.');
