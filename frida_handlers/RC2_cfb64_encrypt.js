/*
 * Auto-generated by Frida. Please modify to match the signature of RC2_cfb64_encrypt.
...
{
  /**
   * Called synchronously when about to call RC2_cfb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('RC2_cfb64_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from RC2_cfb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('RC2_cfb64_encrypt() intercepted onLeave.');
