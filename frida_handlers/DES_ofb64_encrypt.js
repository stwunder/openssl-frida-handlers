/*
 * Auto-generated by Frida. Please modify to match the signature of DES_ofb64_encrypt.
...
{
  /**
   * Called synchronously when about to call DES_ofb64_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('DES_ofb64_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from DES_ofb64_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('DES_ofb64_encrypt() intercepted onLeave.');
