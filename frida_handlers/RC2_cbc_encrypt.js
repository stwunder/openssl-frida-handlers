/*
 * Auto-generated by Frida. Please modify to match the signature of RC2_cbc_encrypt.
...
{
  /**
   * Called synchronously when about to call RC2_cbc_encrypt.
   *
  ...
  onEnter(log, args, state) {
    console.log('RC2_cbc_encrypt() intercepted onEnter.');
  ...
  /**
   * Called synchronously when about to return from RC2_cbc_encrypt.
   *
  ...
  onLeave(log, retval, state) {
    // console.log('RC2_cbc_encrypt() intercepted onLeave.');
    ...
    if(state.rule2_violated >= 0) {
      console.warn("RC2-CBC with constant IV called.");
